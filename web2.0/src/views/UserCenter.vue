  ...
  <div id="venderInfo">
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">{{loginUser}}</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">{{loginUser}}</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-9">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">{{loginUser}}</h3>
              </div>
              <div class="card-body">
                <div class="row">
                  <div class="col-12">
                    ...
                    <b-input-group prepend="密钥" class="mt-3">
                      ...
                      <b-input-group-append>
                        <b-button variant="info" @click.prevent="update({secret:true})">更新</b-button>
                      </b-input-group-append>
                    </b-input-group>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      /**获取码商信息 */
      async getVenInfo() {
        const data = await post(this.path)
        if (data.code == 'ok') {
      ...
      async updateInfo(formdata) {
        ...
        const data = await post(this.updatePath, formdata)
