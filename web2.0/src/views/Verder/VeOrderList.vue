              ...
              <div class="card-body p-0">
                <div class="mailbox-controls">
                  <b-form inline class="placeStyle">
                    ...
                    <!-- <date-picker style="margin:5px;" v-model="form.days" value-type="format" placeholder="创建时间" format="YYYY-MM-DD"></date-picker> -->
  ...
  export default {
    ...
    methods: {
      ...
      async bindOrderList() {
        ...
        const data = await post('/collect/vender/order/list', this.form);
        if (data.code == 'ok') {
