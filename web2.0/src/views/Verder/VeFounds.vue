  ...
  <div id="veFounds">
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">资金记录</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">资金记录</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
              ...
              <div class="card-footer p-0">
                <div class="row">
                  ...
                  <div class="col-md-3" style="text-align:right;">
                    <span style="line-height:40px;margin:0 10px;">共{{totals}}条</span>
                  </div>
                </div>
              </div>
            </div>
...
<script>
  ...
  export default {
    ...
    data() {
      return {
        pageLimits: limits,
        fields: [{ key: 'id', label: 'ID' }, { key: 'mall_id', label: 'mall_id' }, { key: 'group_id', label: "group_id" },
