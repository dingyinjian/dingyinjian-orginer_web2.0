  ...
  <div id="text">
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">线上收款</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">线上收款</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
            ...
            <div class="invoice p-3 mb-3">
              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <!-- <form style="display:none" method="post" action="http://192.168.110.161:9006/collect/transaction/counter"> -->
